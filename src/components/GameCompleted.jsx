...
const GameCompleted = ({ data, handleScreenshot }) => {
    ...
    return (
        <div className="flex font-inter flex-col justify-center items-center">
            ...
            <button onClick={handleClick} className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-4 px-8 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 mt-8">Share Your Victory</button>
